...
file_name = input("please enter the file name which has numbers:(without extention)\n")
with open(file_name + ".txt", 'r') as file: #reading the file which contains random integers
    while flag:
